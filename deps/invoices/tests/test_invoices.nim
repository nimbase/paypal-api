...
suite "invoices serialization":
  test "round-trips InvoicesUpdate422":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesUpdate422)) == openjson.toJson(obj)

  test "round-trips InvoicesRemind400":
    let obj = newInvoicesRemind400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesRemind400)) == openjson.toJson(obj)

  test "round-trips RefundDetail":
    let obj = newRefundDetail()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.RefundDetail)) == openjson.toJson(obj)

  test "round-trips InvoicesCancel400":
    let obj = newInvoicesCancel400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesCancel400)) == openjson.toJson(obj)

  test "round-trips Fetchtype":
    let obj = newFetchtype()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Fetchtype)) == openjson.toJson(obj)

  test "round-trips Error422":
    let obj = newError422()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Error422)) == openjson.toJson(obj)

  test "round-trips InvoicesPayments400":
    let obj = newInvoicesPayments400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesPayments400)) == openjson.toJson(obj)

  test "round-trips InvoicesGenerateQrCode400":
    let obj = newInvoicesGenerateQrCode400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesGenerateQrCode400)) == openjson.toJson(obj)

  test "round-trips Invoice":
    let obj = newInvoice()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Invoice)) == openjson.toJson(obj)
  ...
  test "round-trips InvoicesCreate400":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesCreate400)) == openjson.toJson(obj)

  test "round-trips InvoicesPayments422":
    let obj = newInvoicesPayments422()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesPayments422)) == openjson.toJson(obj)
  ...
  test "round-trips InvoicesCancel422":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesCancel422)) == openjson.toJson(obj)

  test "round-trips InvoiceNumber":
    let obj = newInvoiceNumber()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoiceNumber)) == openjson.toJson(obj)

  test "round-trips Notification":
    let obj = newNotification()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Notification)) == openjson.toJson(obj)

  test "round-trips Invoices":
    let obj = newInvoices()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Invoices)) == openjson.toJson(obj)

  test "round-trips QrConfig":
    let obj = newQrConfig()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.QrConfig)) == openjson.toJson(obj)
  ...
  test "round-trips InvoicesRefunds400":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesRefunds400)) == openjson.toJson(obj)

  test "round-trips PaymentDetail":
    let obj = newPaymentDetail()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.PaymentDetail)) == openjson.toJson(obj)

  test "round-trips 400":
    let obj = new400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Status400)) == openjson.toJson(obj)

  test "round-trips LinkDescription":
    let obj = newLinkDescription()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.LinkDescription)) == openjson.toJson(obj)

  test "round-trips InvoicesPaymentsDelete422":
    let obj = newInvoicesPaymentsDelete422()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesPaymentsDelete422)) == openjson.toJson(obj)

  test "round-trips PaymentReference":
    let obj = newPaymentReference()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.PaymentReference)) == openjson.toJson(obj)

  test "round-trips 422":
    let obj = new422()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Status422)) == openjson.toJson(obj)

  test "round-trips 403":
    let obj = new403()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Status403)) == openjson.toJson(obj)

  test "round-trips InvoicesRefunds422":
    let obj = newInvoicesRefunds422()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesRefunds422)) == openjson.toJson(obj)
  ...
  test "round-trips InvoicesRemind422":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesRemind422)) == openjson.toJson(obj)

  test "round-trips InvoicesUpdate400":
    let obj = newInvoicesUpdate400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesUpdate400)) == openjson.toJson(obj)

  test "round-trips RefundReference":
    let obj = newRefundReference()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.RefundReference)) == openjson.toJson(obj)
