...
suite "templates serialization":
  test "round-trips Template":
    let obj = newTemplate()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Template)) == openjson.toJson(obj)
  ...
  test "round-trips TemplatesCreate422":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.TemplatesCreate422)) == openjson.toJson(obj)
  ...
  test "round-trips TemplatesCreate400":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.TemplatesCreate400)) == openjson.toJson(obj)

  test "round-trips TemplatesGet403":
    let obj = newTemplatesGet403()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.TemplatesGet403)) == openjson.toJson(obj)

  test "round-trips Templates":
    let obj = newTemplates()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.Templates)) == openjson.toJson(obj)

  test "round-trips TemplatesUpdate400":
    let obj = newTemplatesUpdate400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.TemplatesUpdate400)) == openjson.toJson(obj)
  ...
  test "round-trips TemplatesDelete403":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.TemplatesDelete403)) == openjson.toJson(obj)
