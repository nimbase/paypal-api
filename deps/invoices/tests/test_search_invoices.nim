...
suite "search_invoices serialization":
  ...
  test "round-trips SearchData":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.SearchData)) == openjson.toJson(obj)

  test "round-trips InvoicesSearchInvoices400":
    let obj = newInvoicesSearchInvoices400()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), invoices.InvoicesSearchInvoices400)) == openjson.toJson(obj)
