...
#
# Generated at: 2026-08-08T19:13:19+03:00
# License: MIT
...
suite "orders serialization":
  test "round-trips OrderCaptureRequest":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.OrderCaptureRequest)) == openjson.toJson(obj)

  test "round-trips ConfirmOrderRequest":
    let obj = newConfirmOrderRequest()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.ConfirmOrderRequest)) == openjson.toJson(obj)

  test "round-trips OrderRequest":
    let obj = newOrderRequest()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.OrderRequest)) == openjson.toJson(obj)

  test "round-trips Order":
    let obj = newOrder()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.Order)) == openjson.toJson(obj)

  test "round-trips OrderAuthorizeResponse":
    let obj = newOrderAuthorizeResponse()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.OrderAuthorizeResponse)) == openjson.toJson(obj)

  test "round-trips OrderTrackerRequest":
    let obj = newOrderTrackerRequest()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.OrderTrackerRequest)) == openjson.toJson(obj)

  test "round-trips OrderAuthorizeRequest":
    let obj = newOrderAuthorizeRequest()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_orders.OrderAuthorizeRequest)) == openjson.toJson(obj)
