...
type
  OrdersClient* = ref object of RootObj
    baseUri*: string
  ...
  OrdersClientError* = object of CatchableError
...
proc initOrdersClient*: OrdersClient =
  new(result)
...
proc configureOAuth*(client: OrdersClient, clientId, clientSecret: string) =
  client.oauthClientId = some(clientId)
  client.oauthClientSecret = some(clientSecret)

proc setTokens*(client: OrdersClient, accessToken, refreshToken: string,
...
proc canAutoRefresh*(client: OrdersClient): bool =
  client.refreshToken.isSome and
    client.oauthClientId.isSome and
    client.oauthClientSecret.isSome and
    oauthTokenUrl.len > 0

proc tryRefreshToken*(client: OrdersClient): Future[bool] {.async.} =
...
proc httpPost*[T](client: OrdersClient,
...
proc httpPost*(client: OrdersClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPut*[T](client: OrdersClient,
  endpoint: string, body: T): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPut*(client: OrdersClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
  result = await client.httpClient.request(url, httpMethod = HttpPut)
...
proc httpDelete*(client: OrdersClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPatch*[T](client: OrdersClient,
  endpoint: string, body: T): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPatch*(client: OrdersClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
  result = await client.httpClient.request(url, httpMethod = HttpPatch)
