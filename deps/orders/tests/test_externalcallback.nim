...
suite "externalcallback serialization":
  test "round-trips OrderUpdateCallbackResponse":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), orders.OrderUpdateCallbackResponse)) == openjson.toJson(obj)

  test "round-trips OrderUpdateCallbackErrorResponse":
    let obj = newOrderUpdateCallbackErrorResponse()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), orders.OrderUpdateCallbackErrorResponse)) == openjson.toJson(obj)

  test "round-trips OrderUpdateCallbackRequest":
    let obj = newOrderUpdateCallbackRequest()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), orders.OrderUpdateCallbackRequest)) == openjson.toJson(obj)
