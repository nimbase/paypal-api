...
suite "find_eligible_methods serialization":
  test "round-trips FindEligibleMethodsRequest":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), payments.FindEligibleMethodsRequest)) == openjson.toJson(obj)

  test "round-trips FindEligibleMethodsResponse":
    let obj = newFindEligibleMethodsResponse()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), payments.FindEligibleMethodsResponse)) == openjson.toJson(obj)
