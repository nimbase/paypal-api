...
suite "disputes_actions serialization":
  test "round-trips EscalateResponse":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.EscalateResponse)) == openjson.toJson(obj)

  test "round-trips Adjudicate":
    let obj = newAdjudicate()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.Adjudicate)) == openjson.toJson(obj)

  test "round-trips DenyOffer":
    let obj = newDenyOffer()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.DenyOffer)) == openjson.toJson(obj)
  ...
  test "round-trips AcceptOffer":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.AcceptOffer)) == openjson.toJson(obj)

  test "round-trips Escalate":
    let obj = newEscalate()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.Escalate)) == openjson.toJson(obj)

  test "round-trips MakeOffer":
    let obj = newMakeOffer()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.MakeOffer)) == openjson.toJson(obj)

  test "round-trips RequireEvidence":
    let obj = newRequireEvidence()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), disputes.RequireEvidence)) == openjson.toJson(obj)
