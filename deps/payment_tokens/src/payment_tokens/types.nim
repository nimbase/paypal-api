...
type
  ...
  ApplePayPaymentTokenResponse* = ref object of RootObj
    ...
    card*: Option[JsonNode]
      ## The payment card to be used to fund a payment_tokens. Can be a credit or debit card.
  ...
  BinDetails* = ref object of RootObj
    ## Bank Identification Number (BIN) details used to fund a payment_tokens.
    bin*: Option[string]
