...
suite "webhooks_lookup serialization":
  test "round-trips WebhookLookupList":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.WebhookLookupList)) == openjson.toJson(obj)

  test "round-trips WebhooksLookup":
    let obj = newWebhooksLookup()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.WebhooksLookup)) == openjson.toJson(obj)
