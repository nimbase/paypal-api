...
suite "webhooks serialization":
  test "round-trips WebhookList":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.WebhookList)) == openjson.toJson(obj)

  test "round-trips Webhook":
    let obj = newWebhook()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.Webhook)) == openjson.toJson(obj)
  ...
  test "round-trips EventTypeList":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.EventTypeList)) == openjson.toJson(obj)
