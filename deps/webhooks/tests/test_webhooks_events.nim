...
suite "webhooks_events serialization":
  ...
  test "round-trips EventList":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.EventList)) == openjson.toJson(obj)

  test "round-trips EventResend":
    let obj = newEventResend()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), webhooks.EventResend)) == openjson.toJson(obj)
