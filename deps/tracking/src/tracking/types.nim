...
type
  ...
  Carrier* = enum
    ## The carrier for the tracking. Carrier information is required when
  ...
  Tracker* = ref object of RootObj
    ## The tracking information for a tracking.
    transaction_id*: string
      ## The PayPal transaction ID.
    tracking_number*: Option[string]
      ## The tracking number for the tracking. Carrier information, `carrier` is required
    ...
    carrier_name_other*: Option[string]
      ## The name of the carrier for the tracking. Provide this value only if the carrier
      ## parameter is OTHER.
  ...
  TrackerIdentifier* = ref object of RootObj
    ## The tracking identifiers for a tracking.
    transaction_id*: string
      ## The PayPal transaction ID.
    tracking_number*: Option[string]
      ## The tracking number for the tracking.
    links*: Option[LinkDescriptionList]
  ...
  TrackingStatus* = enum
    ## The status of the item tracking. For allowed values, see <a
