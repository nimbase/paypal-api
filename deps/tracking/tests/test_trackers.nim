...
suite "trackers serialization":
  test "round-trips TrackerCollection":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), tracking.TrackerCollection)) == openjson.toJson(obj)

  test "round-trips Tracker":
    let obj = newTracker()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), tracking.Tracker)) == openjson.toJson(obj)

  test "round-trips TrackerIdentifierCollection":
    let obj = newTrackerIdentifierCollection()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), tracking.TrackerIdentifierCollection)) == openjson.toJson(obj)

  test "round-trips Error":
    let obj = newError()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), tracking.Error)) == openjson.toJson(obj)
