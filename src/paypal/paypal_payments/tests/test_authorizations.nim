...
suite "authorizations serialization":
  test "round-trips ReauthorizeRequest":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_payments.ReauthorizeRequest)) == openjson.toJson(obj)
  ...
  test "round-trips CaptureRequest":
    ...
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_payments.CaptureRequest)) == openjson.toJson(obj)

  test "round-trips Authorization2":
    let obj = newAuthorization2()
    check openjson.toJson(openjson.fromJson(openjson.toJson(obj), paypal_payments.Authorization2)) == openjson.toJson(obj)
