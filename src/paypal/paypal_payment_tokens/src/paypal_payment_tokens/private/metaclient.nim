...
#
# Generated at: 2026-08-08T23:06:09+03:00
# License: MIT
...
type
  PaymentTokensClient* = ref object of RootObj
    baseUri*: string
  ...
  PaymentTokensClientError* = object of CatchableError
...
proc initPaymentTokensClient*: PaymentTokensClient =
  new(result)
...
proc configureOAuth*(client: PaymentTokensClient, clientId, clientSecret: string) =
  client.oauthClientId = some(clientId)
  client.oauthClientSecret = some(clientSecret)

proc setTokens*(client: PaymentTokensClient, accessToken, refreshToken: string,
...
proc canAutoRefresh*(client: PaymentTokensClient): bool =
  client.refreshToken.isSome and
    client.oauthClientId.isSome and
    client.oauthClientSecret.isSome and
    oauthTokenUrl.len > 0

proc tryRefreshToken*(client: PaymentTokensClient): Future[bool] {.async.} =
...
proc httpPost*[T](client: PaymentTokensClient,
...
proc httpPost*(client: PaymentTokensClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPut*[T](client: PaymentTokensClient,
  endpoint: string, body: T): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPut*(client: PaymentTokensClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
  result = await client.httpClient.request(url, httpMethod = HttpPut)
...
proc httpDelete*[T](client: PaymentTokensClient,
  endpoint: string, body: T): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpDelete*(client: PaymentTokensClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
  result = await client.httpClient.request(url, httpMethod = HttpDelete)
...
proc httpPatch*[T](client: PaymentTokensClient,
  endpoint: string, body: T): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
...
proc httpPatch*(client: PaymentTokensClient,
  endpoint: string): Future[AsyncResponse] {.async.} =
  client.authRequest
  let url = client.baseUri & endpoint
  result = await client.httpClient.request(url, httpMethod = HttpPatch)
